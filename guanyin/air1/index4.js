        ...
        var formModal = {
            ...
            methods: {
                ...
                renderEditData: function(data) {
                    ...
                    if (upgfType === "3") {
                        airlineType =
                            data.upgAirlineBaseSets[0].intFlag === "I" ? "nation" : "inland";
                        ...
                        $priceTable.bootstrapTable("load", [
                            { currencyName: "人民币", feeDetailList: feeDetails }
                        ]);
            ...
            hooks: {
                ...
                mounted: function() {
                    ...
                    $(document).on('submit','.J-nation-form','.J-inland-form',function(e){
                      e.preventDefault();
                    })
                },
                        ...
                        },
                        {
                            ...
                            formatter: function(value, row) {
                                ...
                                temp = temp
                                    ...
                                    .replace(/\{\{child\}\}/g, child)
                                    .replace(/\{\{baby\}\}/g, baby)
                                    .replace(/\{\{unit\}\}/g, value[0].currencyUnit || "");
                                return temp;
                            }
                        }
                    ]
        ...
        var detailModal = {
            ...
            methods: {
                renderOthers() {
                    ...
                    var upgfTypeLabel = this.state.data.upCabinName;
            ...
            hooks: {
                beforeCreate: function() {
                    ...
                    this.state.upgfType = detailData.upgfType;
                ...
                mounted: function() {
                    ...
                    if (this.state.upgfType === "3") {
                        ...
                        var feeMap = {};
                        feeDetails.forEach(function(item) {
                            if (!feeMap[item.currency]) {
                                feeMap[item.currency] = {
                                    currencyName: item.currencyName,
                                    feeDetailList: [item]
                                };
                            } else {
                                feeMap[item.currency].feeDetailList.push(item);
                            }
                        });
                        for (var key in feeMap) {
                            data.push(feeMap[key]);
                        }
                        $detailPriceTable.bootstrapTable("load", data);
                    } else {
